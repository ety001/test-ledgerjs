...
proto.protocol.AccountId.deserializeBinary = function (bytes) {
    const reader = new GoogleProtobuf.BinaryReader(bytes);
    const msg = new proto.protocol.AccountId();
...
proto.protocol.AccountId.prototype.getName_asB64 = function () {
    return (
    /** @type {string} */
    GoogleProtobuf.Message.bytesAsB64(this.getName()));
};
proto.protocol.AccountId.prototype.getName_asU8 = function () {
    return (
    /** @type {!Uint8Array} */
    GoogleProtobuf.Message.bytesAsU8(this.getName()));
};
...
proto.protocol.authority.deserializeBinary = function (bytes) {
    const reader = new GoogleProtobuf.BinaryReader(bytes);
    const msg = new proto.protocol.authority();
...
proto.protocol.authority.prototype.getPermissionName_asB64 = function () {
    return (
    /** @type {string} */
    GoogleProtobuf.Message.bytesAsB64(this.getPermissionName()));
};
proto.protocol.authority.prototype.getPermissionName_asU8 = function () {
    return (
    /** @type {!Uint8Array} */
    GoogleProtobuf.Message.bytesAsU8(this.getPermissionName()));
};
...
proto.protocol.MarketOrderDetail.deserializeBinary = function (bytes) {
    const reader = new GoogleProtobuf.BinaryReader(bytes);
    const msg = new proto.protocol.MarketOrderDetail();
...
proto.protocol.MarketOrderDetail.prototype.getMakerorderid_asB64 = function () {
    return (
    /** @type {string} */
    GoogleProtobuf.Message.bytesAsB64(this.getMakerorderid()));
};
proto.protocol.MarketOrderDetail.prototype.getMakerorderid_asU8 = function () {
    return (
    /** @type {!Uint8Array} */
    GoogleProtobuf.Message.bytesAsU8(this.getMakerorderid()));
};
...
proto.protocol.MarketOrderDetail.prototype.getTakerorderid_asB64 = function () {
    return (
    /** @type {string} */
    GoogleProtobuf.Message.bytesAsB64(this.getTakerorderid()));
};
proto.protocol.MarketOrderDetail.prototype.getTakerorderid_asU8 = function () {
    return (
    /** @type {!Uint8Array} */
    GoogleProtobuf.Message.bytesAsU8(this.getTakerorderid()));
};
...
if (GoogleProtobuf.Message.GENERATE_TO_OBJECT) {
    ...
    proto.protocol.Transaction.toObject = function (includeInstance, msg) {
        let f, obj = {
            ...
            retList: GoogleProtobuf.Message.toObjectList(msg.getRetList(), proto.protocol.Transaction.Result.toObject, includeInstance),
        };
        if (includeInstance) {
            obj.$jspbMessageInstance = msg;
        }
...
proto.protocol.Transaction.deserializeBinary = function (bytes) {
    const reader = new GoogleProtobuf.BinaryReader(bytes);
    const msg = new proto.protocol.Transaction();
...
proto.protocol.Transaction.Contract.deserializeBinary = function (bytes) {
    const reader = new GoogleProtobuf.BinaryReader(bytes);
    const msg = new proto.protocol.Transaction.Contract();
...
proto.protocol.Transaction.Contract.serializeBinaryToWriter = function (message, writer) {
    ...
    if (f != null) {
        writer.writeMessage(2, f, Any.Any.serializeBinaryToWriter);
    }
...
proto.protocol.Transaction.Contract.prototype.getProvider_asB64 = function () {
    return (
    /** @type {string} */
    GoogleProtobuf.Message.bytesAsB64(this.getProvider()));
};
proto.protocol.Transaction.Contract.prototype.getProvider_asU8 = function () {
    return (
    /** @type {!Uint8Array} */
    GoogleProtobuf.Message.bytesAsU8(this.getProvider()));
};
...
proto.protocol.Transaction.Contract.prototype.getContractname_asB64 = function () {
    return (
    /** @type {string} */
    GoogleProtobuf.Message.bytesAsB64(this.getContractname()));
};
proto.protocol.Transaction.Contract.prototype.getContractname_asU8 = function () {
    return (
    /** @type {!Uint8Array} */
    GoogleProtobuf.Message.bytesAsU8(this.getContractname()));
};
...
if (GoogleProtobuf.Message.GENERATE_TO_OBJECT) {
    ...
    proto.protocol.Transaction.Result.toObject = function (includeInstance, msg) {
        const obj = {
            ...
            orderdetailsList: GoogleProtobuf.Message.toObjectList(msg.getOrderdetailsList(), proto.protocol.MarketOrderDetail.toObject, includeInstance),
        };
        if (includeInstance) {
            obj.$jspbMessageInstance = msg;
        }
...
proto.protocol.Transaction.Result.deserializeBinary = function (bytes) {
    const reader = new GoogleProtobuf.BinaryReader(bytes);
    const msg = new proto.protocol.Transaction.Result();
...
proto.protocol.Transaction.Result.prototype.getOrderid_asB64 = function () {
    return (
    /** @type {string} */
    GoogleProtobuf.Message.bytesAsB64(this.getOrderid()));
};
proto.protocol.Transaction.Result.prototype.getOrderid_asU8 = function () {
    return (
    /** @type {!Uint8Array} */
    GoogleProtobuf.Message.bytesAsU8(this.getOrderid()));
};
...
if (GoogleProtobuf.Message.GENERATE_TO_OBJECT) {
    ...
    proto.protocol.Transaction.raw.toObject = function (includeInstance, msg) {
        const obj = {
            ...
            authsList: GoogleProtobuf.Message.toObjectList(msg.getAuthsList(), proto.protocol.authority.toObject, includeInstance),
            data: msg.getData_asB64(),
            contractList: GoogleProtobuf.Message.toObjectList(msg.getContractList(), proto.protocol.Transaction.Contract.toObject, includeInstance),
...
proto.protocol.Transaction.raw.deserializeBinary = function (bytes) {
    const reader = new GoogleProtobuf.BinaryReader(bytes);
    const msg = new proto.protocol.Transaction.raw();
...
proto.protocol.Transaction.raw.prototype.getRefBlockBytes_asB64 = function () {
    return (
    /** @type {string} */
    GoogleProtobuf.Message.bytesAsB64(this.getRefBlockBytes()));
};
proto.protocol.Transaction.raw.prototype.getRefBlockBytes_asU8 = function () {
    return (
    /** @type {!Uint8Array} */
    GoogleProtobuf.Message.bytesAsU8(this.getRefBlockBytes()));
};
...
proto.protocol.Transaction.raw.prototype.getRefBlockHash_asB64 = function () {
    return (
    /** @type {string} */
    GoogleProtobuf.Message.bytesAsB64(this.getRefBlockHash()));
};
proto.protocol.Transaction.raw.prototype.getRefBlockHash_asU8 = function () {
    return (
    /** @type {!Uint8Array} */
    GoogleProtobuf.Message.bytesAsU8(this.getRefBlockHash()));
};
...
proto.protocol.Transaction.raw.prototype.getScripts_asB64 = function () {
    return (
    /** @type {string} */
    GoogleProtobuf.Message.bytesAsB64(this.getScripts()));
};
proto.protocol.Transaction.raw.prototype.getScripts_asU8 = function () {
    return (
    /** @type {!Uint8Array} */
    GoogleProtobuf.Message.bytesAsU8(this.getScripts()));
};
...
proto.protocol.Transaction.prototype.getSignatureList_asB64 = function () {
    return (
    /** @type {!Array<string>} */
    GoogleProtobuf.Message.bytesListAsB64(this.getSignatureList()));
};
proto.protocol.Transaction.prototype.getSignatureList_asU8 = function () {
    return (
    /** @type {!Array<!Uint8Array>} */
    GoogleProtobuf.Message.bytesListAsU8(this.getSignatureList()));
};
...
proto.protocol.TriggerSmartContract.deserializeBinary = function (bytes) {
    const reader = new GoogleProtobuf.BinaryReader(bytes);
    const msg = new proto.protocol.TriggerSmartContract();
...
proto.protocol.TriggerSmartContract.prototype.getOwnerAddress_asB64 = function () {
    return (
    /** @type {string} */
    GoogleProtobuf.Message.bytesAsB64(this.getOwnerAddress()));
};
proto.protocol.TriggerSmartContract.prototype.getOwnerAddress_asU8 = function () {
    return (
    /** @type {!Uint8Array} */
    GoogleProtobuf.Message.bytesAsU8(this.getOwnerAddress()));
};
